...
namespace EventBackend.Hubs
{
    ...
    {
        Task<bool> CreaEventoCondiviso(PropostaEvento evento, string gruppoPromotore, List<string> gruppiInvitati, string username);        Task<List<Invito>> GetInviti(string nomeEvento, string gruppoPromotore);
